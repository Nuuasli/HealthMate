                ...
                <div class="flex justify-around w-full">
                    ...
                    <div class="w-1/2 p-2 mx-auto  -mt-48">
                        <div class="p-6 border-b-2 border-l-2">
                            <h1 class="uppercase text-white font-semibold text-4xl py-4">member gym - <span class="font-normal text-3xl normal-case">Rp. 550.000,00</span> Per-bulan</h1>
                            ...
                            <a href="" class="text-white border-b-2 capitalize py-2 border-white ">lihat
                                lebih
                                lanjut</a>
                        </div>
                        <div class="p-4 border-l-2">
                            ...
                            <a href="" class="text-white border-b-2 capitalize py-2 border-white ">
