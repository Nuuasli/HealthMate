        ...
        <div class="flex flex-wrap w-full md:w-1/3 mb-8 md:mb-0">
            <div class="mx-auto">
                <ul>
                    ...
                    <li class="mb-6"><a href="/about" class="hover:text-primary font-semibold uppercase">About</a>
                    </li>
                    <li class="mb-6"><a href="/service" class="hover:text-primary font-semibold uppercase">Service</a>
                    </li>
                </ul>
            </div>
            <div class="mx-auto">
