...
@section('content')
    <div class="w-4/5 px-6 py-4 absolute ">
        <div class="flex flex-wrap">
            ...
            <div class="mb-6 p-2 w-1/3 relative ">
                ...
                <div class="block w-full h-full bg-slate-200 rounded-md shadow-md overflow-hidden mx-auto group relative">
                    <!-- Image with grayscale effect and hover to color -->
                    <div class="flex w-full">
                        <h1 class="text-4xl mx-auto text-primary capitalize font-Rowdies px-6 py-6">Pendaftaran</h1>
                    </div>

                    <div class="flex w-full">
                        <h1 class="text-3xl mx-auto capitalize font-Rowdies py-6">{{ $count_r }}</h1>
                    </div>
