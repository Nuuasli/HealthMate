        ...
        <div class="w-full shadow-lg flex font-mono h-[700px] ">
            <div class="relative banner w-full h-full ">
                ...
                <div class="absolute w-2/5 px-4 py-4 top-44 left-16">
                    ...
                    <p class="font-medium text-md text-white backdrop-blur-sm p-2 rounded-md">Selamat datang di HealthMate, gym 24/7 yang selalu siap mendukung perjalanan kebugaran Anda kapan saja! Dengan fasilitas yang lengkap dan nyaman, HealthMate memberikan kebebasan bagi Anda untuk berlatih sesuai jadwal tanpa batasan waktu. Baik pagi, siang, malam, bahkan tengah malam sekalipun - pintu kami selalu terbuka untuk Anda.</p>
        ...
        <div class="w-full">
            <div class="w-full px-6 py-4 mx-auto ">
                ...
                <div class="flex flex-wrap">
                    <div class="w-1/2 p-2">
                        <div class="p-6">
                            <h1 class="uppercase text-primary font-semibold text-4xl py-4">member gym - <span class="font-normal text-3xl normal-case">Rp. 550.000,00</span></h1>
